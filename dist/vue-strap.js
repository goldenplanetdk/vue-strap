	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    validate: function validate() {
	      ...
	      if ((0, _typeof3.default)(this.val) === Number) {
	        var _value = this.val;
	      } else {
	        var _value2 = (this.val || '').trim();
	      }
	      if (!value) {
