  ...
  <div>
    ...
    <div id="wrapper">
      <div class="bs-docs-header">
        <div class="container">
          ...
          <br>
          <p><a class="btn btn-outline-inverse btn-lg" href="https://github.com/themcaffee/vue-strap">Code on GitHub</a></p>
        </div>
      </div>
    ...
    <footer class="bs-docs-footer">
      <div class="container">
        ...
        <p>Expanded on by <ahref="https://github.com/themcaffee/">themcaffee</a>.</p>
        <p>
